...
SELECT name, code from country where region = 'Southern Europe' ORDER BY population ASC limit 5;

Ans: Holy See (Vatican City State)
Country Code = 'VAT'
...
SELECT language from countrylanguage where countrycode character ='VAT';
...
SELECT name,code from country where region = 'South America';
...
SELECT name,population from country where population > 90000 ORDER BY population ASC;
